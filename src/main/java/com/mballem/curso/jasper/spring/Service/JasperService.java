...
public class JasperService {
    ...
    public byte[] exportarPDF(String codigoRelatorio){

        byte[] bytes = null;

        try {
            File file = ResourceUtils.getFile(JASPER_DIRETORIO.concat(JASPER_PREFIXO).concat(codigoRelatorio).concat(JASPER_SUFIXO));
